    ...
    //    val reference=FirebaseDatabase.getInstance().getReference("/messages").push()
        ...
        reference.setValue(chatMessage)
            .addOnSuccessListener {
                ...
                edittext_chat_log.text.clear()  //used to clearing the text after sending the message
                recyclerview_chat_log.scrollToPosition(adapter.itemCount-1)  // used for scrolling at the bottom of the recylerview of the message activity
